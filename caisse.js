...
function reset() {
  ...
  document.getElementbyId("input-debut").value = "00.00"; // réinitialiser données
  document.getElementbyId("input-fin").value = "00.00"; //pareil ici le but étant de partir complètement à zéro
